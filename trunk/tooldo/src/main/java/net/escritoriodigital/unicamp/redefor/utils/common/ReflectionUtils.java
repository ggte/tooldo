...
/**
 * <p>
 * A set of utility methods to make working with Classes and Reflection a little
 * easier.
 * </p>
 */
public final class ReflectionUtils {
	 ...
	 * .contextDestroyed()</code>
	 * is called.
	 * </p>
	 * 
	 * @param loader
	 *            the <code>ClassLoader</code> whose associated cache should
	 *            be cleared
	 */
	...
	public static Constructor lookupConstructor(Class<?> clazz, Class<?>... params) {
		...
		ClassLoader loader = getCurrentLoader(clazz);
		if (loader == null) {
			return null;
		}
	...
	public static Object newInstance(String className) throws InstantiationException, IllegalAccessException {
		...
		ClassLoader loader = getCurrentLoader(null);
		if (loader == null) {
			return null;
		}
	...
	private static MetaData getMetaData(ClassLoader loader, String className) {
		...
		if (meta == null) {
			try {
				Class<?> clazz = loadClass(className, cache);
				meta = new MetaData(clazz);
	...
	private static final class MetaData {
		 ...
		 * @return the <code>Method</code> appropriate to the specified name
		 *         and parameters or <code>null</code>
		 */
