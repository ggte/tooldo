package net.escritoriodigital.unicamp.redefor.utils.criptography;
...
public class TripleDESUtils {
	 ...
	 */
	public static TripleDESUtils newInstance() throws InvalidKeyException,
			UnsupportedEncodingException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidKeySpecException {
		return new TripleDESUtils();
	}
	 ...
	 * @throws InvalidKeySpecException
	 */
	private TripleDESUtils() throws UnsupportedEncodingException,
			NoSuchAlgorithmException, NoSuchPaddingException,
			InvalidKeyException, InvalidKeySpecException {
		String key = "net.escriotriodigital.unicamp.redefor";
