...
/**
 * @author andrefabbro
 * fonte: http://showcase.richfaces.org/richfaces/component-sample.jsf?demo=dataTable&sample=arrangeableModel&skin=blueSky
 *
 */
public abstract class JPADataModel<T extends ModelBase> extends ExtendedDataModel<T> implements Arrangeable {
    ...
    public JPADataModel(EntityManager em, Class<T> entityClass) {
        super();
    ...
    @Override
    public T getRowData() {
        return em.find(entityClass, rowKey);
    }
